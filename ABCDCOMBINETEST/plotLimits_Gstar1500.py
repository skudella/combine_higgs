...
filestWbNar=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigGstar*1500*tWbNar*ABCD5/Asymptotic/higgs*.root")
filesttZNar=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigGstar*1500*ttZNar*ABCD5/Asymptotic/higgs*.root")
filesttHNar=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigGstar*1500*ttHNar*ABCD5/Asymptotic/higgs*.root")
filesBRNar=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigGstar*1500*BR05_025_025Nar*ABCD5/Asymptotic/higgs*.root")

filestWbWid=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigGstar*1500*tWbWid*ABCD5/Asymptotic/higgs*.root")
filesttZWid=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigGstar*1500*ttZWid*ABCD5/Asymptotic/higgs*.root")
filesttHWid=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigGstar*1500*ttHWid*ABCD5/Asymptotic/higgs*.root")
filesBRWid=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigGstar*1500*BR05_025_025Wid*ABCD5/Asymptotic/higgs*.root")
...
def drawlimits(files,decaymode):
    ...
    for afile in files:
      print afile
      if ("Nar" in decaymode):  
        for zm in [2000,2250,2500,2750,3000]:
            if str(zm) in afile:
                print zm, " in ", afile
                unsortedmass.append(zm)
      if ("Wid" in decaymode):  
        for zm in [2000,2500,3000]:
            if str(zm) in afile:
                print zm, " in ", afile
                unsortedmass.append(zm)
    ...
    for m in unsortedmass:
        ...
        #if decaymode is "BR":
        f = TFile("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigGstar"+str(m)+"1500_"+decaymode+"_ABCD5/Asymptotic/higgsCombine_Asymptotic.Asymptotic.mH120.root","READ")
        print f
    ...
    theory_mT1500 = array('d', [1.24465,1.74839,1.50185,1.23982,0.985793,0.372771,0.334172,0.253989,0.177661,0.13054,0.104987,0.114843,0.0707403])#gstar
    ...
    v_theory = TVectorD(len(theory_mT1500),theory_mT1500)
    ...
    dummy.GetYaxis().SetRangeUser(0.005,5)   
    ...
    #legend.SetHeader("                    M_{T'} = 1.5 TeV   ")
    legend.SetTextSize(0.03)
    if decaymode is "BR05_025_025Nar":
        legend.SetHeader("#Gamma(Z')/m(Z')=1%, M_{T'} = 1.5 TeV, BR(T' #rightarrow Wb,Ht,Zt)=50%,25%,25%")
    elif decaymode is "tWbNar":
        legend.SetHeader("#Gamma(Z')/m(Z')=1%, M_{T'} = 1.5 TeV, BR(T' #rightarrow Wb,Ht,Zt)=100%,0%,0%")
    elif decaymode is "ttZNar":
        legend.SetHeader("#Gamma(Z')/m(Z')=1%, M_{T'} = 1.5 TeV, BR(T' #rightarrow Wb,Ht,Zt)=0%,0%,100%")
    elif decaymode is "ttHNar":
        legend.SetHeader("#Gamma(Z')/m(Z')=1%, M_{T'} = 1.5 TeV, BR(T' #rightarrow Wb,Ht,Zt)=0%,100%,0%")
    if decaymode is "BR05_025_025Wid":
        legend.SetHeader("#Gamma(Z')/m(Z')=30%, M_{T'} = 1.5 TeV, BR(T' #rightarrow Wb,Ht,Zt)=50%,25%,25%")
    elif decaymode is "tWbWid":
        legend.SetHeader("#Gamma(Z')/m(Z')=30%, M_{T'} = 1.5 TeV, BR(T' #rightarrow Wb,Ht,Zt)=100%,0%,0%")
    elif decaymode is "ttZWid":
        legend.SetHeader("#Gamma(Z')/m(Z')=30%, BR(T' #rightarrow Wb,Ht,Zt)=0%,0%,100%")
    elif decaymode is "ttHWid":
        legend.SetHeader("#Gamma(Z')/m(Z')=30%, BR(T' #rightarrow Wb,Ht,Zt)=0%,100%,0%")
    else:
        print "hihi"
    ...
    c.SaveAs("limit_Gstar1500_"+decaymode+".pdf")
