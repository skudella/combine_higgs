...
def drawlimits(files,decaymode):
    ...
    gr_obs = TGraphAsymmErrors(v_mass,v_exp,v_zeros,v_zeros,v_zeros,v_zeros)
    ...
    if decaymode is "BR05_025_025Nar":
        legend.SetHeader("#Gamma(Z')/m(Z')=1%, M_{T'} = 1.2 TeV, BR(T' #rightarrow Wb,Ht,Zt)=50%,25%,25%")
    elif decaymode is "tWbNar":
        legend.SetHeader("#Gamma(Z')/m(Z')=1%, M_{T'} = 1.2 TeV, BR(T' #rightarrow Wb,Ht,Zt)=100%,0%,0%")
    elif decaymode is "ttZNar":
        legend.SetHeader("#Gamma(Z')/m(Z')=1%, M_{T'} = 1.2 TeV, BR(T' #rightarrow Wb,Ht,Zt)=0%,0%,100%")
    elif decaymode is "ttHNar":
        legend.SetHeader("#Gamma(Z')/m(Z')=1%, M_{T'} = 1.2 TeV, BR(T' #rightarrow Wb,Ht,Zt)=0%,100%,0%")
    if decaymode is "BR05_025_025Wid":
        legend.SetHeader("#Gamma(Z')/m(Z')=30%, M_{T'} = 1.2 TeV, BR(T' #rightarrow Wb,Ht,Zt)=50%,25%,25%")
    elif decaymode is "tWbWid":
        legend.SetHeader("#Gamma(Z')/m(Z')=30%, M_{T'} = 1.2 TeV, BR(T' #rightarrow Wb,Ht,Zt)=100%,0%,0%")
    ...
    c.SaveAs("limit_Gstar_"+decaymode+".pdf")
