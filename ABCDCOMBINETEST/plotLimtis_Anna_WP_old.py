...
filestWb=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/Sig*1200*tWb*ABCD5_Anna_WP_nodynEvtHT/Asymptotic/higgs*.root")
filesttZ=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/Sig*1200*ttZ*ABCD5_Anna_WP_nodynEvtHT/Asymptotic/higgs*.root")
filesttH=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/Sig*1200*ttH*ABCD5_Anna_WP_nodynEvtHT/Asymptotic/higgs*.root")
filesBR=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/Sig*1200*BR*ABCD5_Anna_WP_nodynEvtHT/Asymptotic/higgs*.root")
...
def drawlimits(files,decaymode):
    ...
    for m in unsortedmass:
        ...
        if decaymode is "BR":
            f = TFile("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigZprime"+str(m)+"1200_BR05_025_025_ABCD5_Anna_WP_nodynEvtHT/Asymptotic/higgsCombine_Asymptotic.Asymptotic.mH120.root","READ")
        elif decaymode is "tWb":
            f = TFile("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigZprime"+str(m)+"1200_tWb_ABCD5_Anna_WP_nodynEvtHT/Asymptotic/higgsCombine_Asymptotic.Asymptotic.mH120.root","READ")
        elif decaymode is "ttZ":
            f = TFile("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigZprime"+str(m)+"1200_ttZ_ABCD5_Anna_WP_nodynEvtHT/Asymptotic/higgsCombine_Asymptotic.Asymptotic.mH120.root","READ")
        elif decaymode is "ttH":
            f = TFile("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigZprime"+str(m)+"1200_ttH_ABCD5_Anna_WP_nodynEvtHT/Asymptotic/higgsCombine_Asymptotic.Asymptotic.mH120.root","READ")
        else:
            print "hihi"

        #filename=glob.glob("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/plotutils_workspaces/SigZprime"+str(m)+"1200*"+decaymode+"*ABCD5_Anna_WP_nodynEvtHT/higgsCombine_Asymptotic.Asymptotic.mH120.root")
    ...
    c.SaveAs("limit_Anna_WP_nodynEvtHT_"+decaymode+".pdf")
