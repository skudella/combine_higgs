...
def drawlimits(files,decaymode):
    ...
    twb  = array('d', [4.6,0.093,0.046])
    ttZ  = array('d', [0.8,0.14,0.065])
    ttH  = array('d', [2.1,0.35,0.17])

    anna_twb  = array('d', [1.2,0.3,0.22])
    anna_ttZ  = array('d', [0.2,0.08,0.042])
    anna_ttH  = array('d', [0.1,0.05,0.03])    
    ...
    gr_v_anna_exp_btW.SetLineColor(4)
    ...
    gr_v_anna_exp_ttZ.SetLineColor(6)
    ...
    gr_v_anna_exp_ttH.SetLineColor(7)
    ...
    legend.AddEntry(gr_exp_twb , "bW full-had (exp. 95% limit)", "l")
    legend.AddEntry(gr_exp_ttZ , "tZ full-had (exp. 95% limit)", "l")
    legend.AddEntry(gr_exp_ttH , "tH full-had (exp. 95% limit)", "l")
    legend.AddEntry(gr_v_anna_exp_btW , "bW semi-lep. (exp. 95% limit)", "l")
    legend.AddEntry(gr_v_anna_exp_ttZ , "tZ semi-lep. (exp. 95% limit)", "l")
    legend.AddEntry(gr_v_anna_exp_ttH , "tH semi-lep. (exp. 95% limit)", "l")
