...
def drawlimits(files,decaymode):
    ...
    for m in unsortedmass:
        ...
        if decaymode is "BR":
            f = TFile("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigZprime"+str(m)+"1200_BR05_025_025_ABCD5_CMS_WP/Asymptotic/higgsCombine_Asymptotic.Asymptotic.mH120.root","READ")
            ...
            f = TFile("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigZprime"+str(m)+"1200_ttZ_ABCD5_CMS_WP/Asymptotic/higgsCombine_Asymptotic.Asymptotic.mH120.root","READ")
        elif decaymode is "ttH":
            f = TFile("/nfs/dust/cms/user/skudella/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/data/ZprimeToTprimeAllHadronic/ABCDCOMBINETEST/combine_workspaces/SigZprime"+str(m)+"1200_ttH_ABCD5_CMS_WP/Asymptotic/higgsCombine_Asymptotic.Asymptotic.mH120.root","READ")
        else:
            print "hihi"
    ...
    c.SaveAs("limit_CMS_WP_new_"+decaymode+".pdf")
